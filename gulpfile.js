...
gulp.task("typedoc", function () {
    child_process.exec("typedoc --out ./docs --target es5 --name photographyApp ./src/");
});
...
gulp.task('compress', ['concat-compiled-ts'], function () {
    return gulp.src('./dist/photographyApp.js')
      .pipe(uglify())
        .pipe(rename({
            extname: '.min.js'
        }))
